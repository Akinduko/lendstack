...
class Guarantor extends Component {
  ...
  render() {
    return (
      ...
      <div className="add-new-guarantor">
      <Input className="submit" onClick={()=>this.redirect("/add-guarantor")} type="submit" value="ADD NEW GUARANTOR"/>
      </div>
      </div>
    );
  }
